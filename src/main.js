import './style.css';
const PROFILE = {"day":"Day014","title":"Onboarding Checklist Smith","one_sentence":"新メンバーの初週導線を迷わず回すためのオンボーディング設計ツール。（話題:HN Frontpage）","core_action":"compose","family":"onboarding_flow","mechanic":"milestone_chunking","input_style":"role_and_tasks","output_style":"onboarding_plan","audience_promise":"faster_team_rampup","publish_hook":"初週で迷わない受け入れ手順を即生成","engine":"checklist_builder"};
